...
export default function Footer() {
  return <footer className="fixed-bottom text-center text-lg-start bgnavbar">
      ...
      <div className="container text-center text-md-start mt-5">
        ...
        <div className="row mt-3">
          ...
          <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            ...
            <img src={logo} width={40} className='mb-2'/> Talabatk Eh
            </h6>
            <p>
          ...
          <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="#!" className="text-reset text-decoration-none">Seif Eldein Ahmed</a>
            </p>
            <p>
              <a href="#!" className="text-reset text-decoration-none">Mohamed Mahmoud</a>
            </p>
            <p>
              <a href="#!" className="text-reset text-decoration-none">Ahmed Tarek</a>
            </p>
            <p>
              <a href="#!" className="text-reset text-decoration-none">Farah Ali</a>
            </p>
            <p>
              <a href="#!" className="text-reset text-decoration-none">Nourhan Shawky</a>
            </p>
          </div>

        ...
        <>
            <div className="row">
                ...
                <div className="col-md-7 mt-2 rounded-pill h-25">
                    <button className='btn greencart col-md-12 rounded-pill ' style={{ height: "60px" }}><strong className='text-white'>Add to Cart <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-handbag pb-1" viewBox="0 0 16 16">

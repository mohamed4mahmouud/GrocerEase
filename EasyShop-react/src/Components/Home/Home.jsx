                ...
                <div className="row d-flex  col-md-12 mt-5 mb-5">
                    <div className="col-md-4">
                        ...
                        <Link
                            ...
                            to={"/shops/supermarket"}
                        >
                            <img
                                src="../../images/superMarket.png"
                                alt="superMarket"
                                className={`${style.category} rounded-pill mb-3 w-50`}
                            />
            ...
            <div className={`${style.homeFooter} text-center`}>
                <div className="col-md-12 d-flex row justify-content-around p-5">
                    <div className="col-md-12 mb-5 mt-2">
                        <p className="h1">
                            Why Choose{" "}
                            <span className={`${style.diffColor}`}>
                                GrocerEase
                            </span>
                        </p>
                    </div>
                    <div className="col-md-2 text-start">
                        ...
                        <p className="h6">
                            Discover new tastes, flavours, snacks and recipes to
                            make wonderful meals. Also find out where your food
                    ...
                    <div className="col-md-2 text-start">
                        ...
                        <p className="h6">
                            We offer bulk formats, variety cases, and discovery
                            boxes so you can save money on delicious foods by
                    ...
                    <div className="col-md-2 text-start">
                        ...
                        <p className="h6">
                            By buying in bulk from local and Canadian producers
                            you are helping grow our local food ecosystem,
                            creating jobs, and supporting families and
                    ...
                    <div className="col-md-2 text-start">
                        ...
                        <p className="h6">
                            We only offer great tasting, all natural foods that
                            are better for you, and organic if possible.
                        </p>
                    </div>
                    <div className="col-md-2 text-start">
                        ...
                        <p className="h6">
                            As a member of our club, we will make sure you are
                            delighted with our service or we will make it right!
                        </p>
                    </div>
                </div>
            </div>

...
Route::get('/minAmountShops/{category}', [ShopsController::class, 'getFilteredShopsByMinAmount']);
...
//update shop route
Route::middleware(['auth:sanctum', 'checkStoreOwnerToken'])->put('/shops/{id}', [ShopsController::class,  'updateShop']);
